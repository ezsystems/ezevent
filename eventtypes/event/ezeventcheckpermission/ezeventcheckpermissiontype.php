...
class eZEventCheckPermissionType extends eZWorkflowEventType
{
    const EZ_WORKFLOW_TYPE_UPDATEEVENTS = "ezeventcheckpermission";
    ...
    public function __construct()
    {
        ...
        $this->eZWorkflowEventType(
            eZEventCheckPermissionType::EZ_WORKFLOW_TYPE_UPDATEEVENTS,
    ...
    {
        eZDebug::writeError( 'Event eZEventCheckPermissionType executed on publish.' );
