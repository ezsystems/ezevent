...
<div id="ezeventattribute" class="block">
    <div class="ezeventattribute-left">
                ...
                <div id="ezeventattribute_selection" class="float-break">
                    ...
                    <ul>
                        <li>
                            <input onchange="ezevent_is_full_day(this.checked)" type="checkbox" name="{$attribute_base}_event_eventmode_{$attribute.id}" value="full-day" {if $event_mode|eq('full-day')}checked="checked"{/if} />{'Full Day'|i18n( 'design/ezevent/content/datatype' )}
                        </li>
{*                        <li>
                            <input onchange="ezevent_is_full_day(this.checked)" type="checkbox" name="{$attribute_base}_event_eventmode_{$attribute.id}" value="full-day" {if $event_mode|eq('full-day')}checked="checked"{/if} />{'Recurrence'|i18n( 'design/ezevent/content/datatype' )}
                        </li>*}
                    </ul>
                </div>
                <br />
                <div id="ezeventattribute_selection" class="float-break">
                    <label>{'Select recurrence'|i18n( 'design/ezevent/content/datatype' )}:</label>
                    <ul>
                        <li>
                            <input onclick="ezevent_setedittype(11)" type="radio" name="{$attribute_base}_event_typeofevent_{$attribute.id}" value="11" {if $event_type|eq(11)}checked="checked"{/if} />{'None'|i18n( 'design/ezevent/content/datatype' )}
                        </li>
                        <li>
                            <input onclick="ezevent_setedittype(15)" type="radio" name="{$attribute_base}_event_typeofevent_{$attribute.id}" value="15" {if $event_type|eq(15)}checked="checked"{/if} />{'Weekly'|i18n( 'design/ezevent/content/datatype' )}
                        </li>
                        <li>
                            <input onclick="ezevent_setedittype(16)" type="radio" name="{$attribute_base}_event_typeofevent_{$attribute.id}"  value="16" {if $event_type|eq(16)}checked="checked"{/if} />{'Monthly'|i18n( 'design/ezevent/content/datatype' )}
                        </li>
                        <li>
                            <input onclick="ezevent_setedittype(17)" type="radio" name="{$attribute_base}_event_typeofevent_{$attribute.id}"  value="17" {if $event_type|eq(17)}checked="checked"{/if} />{'Yearly'|i18n( 'design/ezevent/content/datatype' )}
                        </li>
                    </ul>
                </div>
                ...
                <div id="ezeventattribute_label_startdate">
                    <label>{'Startdate'|i18n( 'design/ezevent/content/datatype' )}</label>
                </div>
                <div id="ezeventattribute_label_date_from">
                    <label>{'Date'|i18n( 'design/ezevent/content/datatype' )}</label>
                </div>
                ...
                <div >
                    ...
                    <label id="ezeventattribute_label_enddate">{'Enddate'|i18n( 'design/ezevent/content/datatype' )}</label>
                    <label id="ezeventattribute_label_period_till">{'Recur till'|i18n( 'design/ezevent/content/datatype' )}</label>
                </div>
                <div class="float-break"></div>
    ...
    <div class="ezeventattribute-right">
            ...
            {*
                        <br />
                        <a href="#" onclick="ezajaxSearchLink( {"ezajax/subtree/2/teamroom/0/30"|ezurl('single')}, 'ajaxsearchresult' );toggleSubElements( this, 'ajaxsearchresult' );return false;">{"other teamrooms"|i18n('design/ezevent/content/datatype')}</a>
                        <div class="block search-results">
