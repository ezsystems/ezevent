...
<table border="0" width="100%" class="ezevent_structural_table"><tr><td>
    {if $attribute.content.has_parent_event}
        ...
        <p>{'You are editing a single date of the recurent event "%name"<br />(period from %start to %end)'|i18n( 'design/ezevent/content/datatype',,hash( '%name', $attribute.content.parent_event.content_object.name|wash() , '%start', $attribute.content.parent_event.start.timestamp|l10n(shortdate), '%end', $attribute.content.parent_event.end.timestamp|l10n(shortdate) ) )}</p>
    {else}
    <div id="ezeventattribute_selection">
        <label>{'Select type'|i18n( 'design/ezevent/content/datatype' )}:</label><br />
        <input onclick="ezevent_seteditmode(11)" type="radio" name="{$attribute_base}_event_typeofevent_{$attribute.id}" value="11" {if $event_type|eq(11)}checked="checked"{/if} />{'Normal'|i18n( 'design/ezevent/content/datatype' )}
        <input onclick="ezevent_seteditmode(12)" type="radio" name="{$attribute_base}_event_typeofevent_{$attribute.id}" value="12" {if $event_type|eq(12)}checked="checked"{/if} />{'Full Day'|i18n( 'design/ezevent/content/datatype' )}
        <input onclick="ezevent_seteditmode(15)" type="radio" name="{$attribute_base}_event_typeofevent_{$attribute.id}" value="15" {if $event_type|eq(15)}checked="checked"{/if} />{'Weekly'|i18n( 'design/ezevent/content/datatype' )}
        <input onclick="ezevent_seteditmode(16)" type="radio" name="{$attribute_base}_event_typeofevent_{$attribute.id}"  value="16" {if $event_type|eq(16)}checked="checked"{/if} />{'Monthly'|i18n( 'design/ezevent/content/datatype' )}
        <input onclick="ezevent_seteditmode(17)" type="radio" name="{$attribute_base}_event_typeofevent_{$attribute.id}"  value="17" {if $event_type|eq(17)}checked="checked"{/if} />{'Yearly'|i18n( 'design/ezevent/content/datatype' )}
    </div>
    {/if}
    ...
    <div id="ezeventattribute_startdate">
        <label id="ezeventattribute_startdate_label">{'Startdate'|i18n( 'design/ezevent/content/datatype' )}</label>
        <div class="block float-break">
            <div class="element">
                <label>{'Year'|i18n( 'design/ezevent/content/datatype' )}:</label><br />
            ...
            <div class="element">
                <label>{'Month'|i18n( 'design/ezevent/content/datatype' )}:</label><br />
            ...
            <div class="element">
                <label>{'Day'|i18n( 'design/ezevent/content/datatype' )}:</label><br />
    ...
    <div id="ezeventattribute_starttime">
        <label id="ezeventattribute_starttime_label">{'Starttime'|i18n( 'design/ezevent/content/datatype' )}</label>
        <div class="block float-break">
            <div class="element">
                <label>{'Hour'|i18n( 'design/ezevent/content/datatype' )}:</label><br />
            ...
            <div class="element">
                <label>{'Minute'|i18n( 'design/ezevent/content/datatype' )}:</label><br />
    ...
    <div id="ezeventattribute_enddate">
        <label id="ezeventattribute_enddate_label">{'Enddate'|i18n( 'design/ezevent/content/datatype' )}</label>
        <div class="block float-break">
            <div class="element">
                <label>{'Year'|i18n( 'design/ezevent/content/datatype' )}:</label><br />
    ...
    <div id="ezeventattribute_endtime">
        <label id="ezeventattribute_endtime_label">{'Endtime'|i18n( 'design/ezevent/content/datatype' )}</label>
        <div class="block float-break">
            <div class="element">
                <label>{'Hours'|i18n( 'design/ezevent/content/datatype' )}:</label><br />
            ...
            <div class="element">
                <label>{'Minutes'|i18n( 'design/ezevent/content/datatype' )}:</label><br />
